...
export default function GroupsSection({ user }: GroupsSectionProps) {
  ...
  // Top 5 featured colleges
  const topColleges = [
    { id: 'andhra-university', name: 'Andhra University', location: 'Visakhapatnam', members: 2847 },
    { id: 'gitam-university', name: 'GITAM University', location: 'Visakhapatnam', members: 3241 },
    { id: 'gvpce', name: 'GVPCE(A)', location: 'Visakhapatnam', members: 1523 },
    { id: 'iit-bombay', name: 'IIT Bombay', location: 'Mumbai', members: 4521 },
    { id: 'nit-trichy', name: 'NIT Tiruchirappalli', location: 'Tiruchirappalli', members: 3876 }
  ]
